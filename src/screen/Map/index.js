  ...
  return (
    <ScrollView>
      <View style={[tw`flex flex-row`]}>
        <Text style={[tw `text-3xl text-gray-700 text-center font-bold ml-21 mt-9`]}> Location </Text>
      ...
      <View style={[tw`h-265 bg-white`]}>
      <View style={[tw`flex flex-cols`]}>

        <View style={[tw`rounded-xl bg-gray-100 mt-5 ml-5 mb-1 w-81 h-45`]}>
        ...
        <View style={[tw`bg-gray-100 mb-2 ml-0.21`]}>
         <TouchableOpacity><Image style={[tw`rounded-sm w-full h-35 mt-3 mb-1 justify-center items-center`]} source={require('../../assets/test.jpg')}/></TouchableOpacity> 
        </View>
        </View>

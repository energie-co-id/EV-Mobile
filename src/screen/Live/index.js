  ...
  return (
    ...
    <View style={[tw`flex flex-row bg-white`]}>
     ...
     <View style={[tw`bg-white w-40 mt-3 ml-5`]}>
        ...
        <Icon style={[tw`rounded-xl bg-gray-200 ml-11 text-center w-20 p-1`]} name='ev-station' size={50} color={'#666666'} />
    ...
    <View style={[tw`bg-white w-38 mt-3 ml-3.5`]}>
         ...
         <Icon style={[tw` rounded-xl bg-gray-200 ml-10.5 text-center w-20 p-1`]} name='timer' size={50} color={'#666666'} />
     ...
     <TouchableOpacity onPress={() => props.navigation.navigate("Live")}><Icon style={[tw`ml-3 mt-3`]} name='power-settings-new' size={95} color={'#666666'} /></TouchableOpacity> 
        </View>

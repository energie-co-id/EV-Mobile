...
function Profile(props) {
  ...
  return (
    <ScrollView>
        ...
        <View style={[tw`flex flex-row bg-gray-200`]}>
        <Text style={[tw`bg-gray-200 text-gray-700 text-2xl font-semibold ml-5 mt-3`]}>Lucy</Text>
        ...
        <Text style={[tw`text-gray-700 text-2xl font-semibold ml-7 mb-3`]}>Lucy</Text>
        </View>
    
         <View style={[tw`bg-gray-200 mt-15 w-1/4`]}>
          <Text style={[tw`text-gray-700 text-2xl font-bold mt-14 ml-7`]}>105K</Text>
          <Text style={[tw`text-gray-500 text-xl font-normal ml-5 mb-3`]}>Charged</Text>
        </View>

        <View style={[tw`bg-gray-200 mt-15 w-1/4`]}>
          <Text style={[tw`text-gray-700 text-2xl font-bold mt-14 ml-5`]}>40.1K</Text>
          <Text style={[tw`text-gray-500 text-xl font-normal ml-5 mb-5`]}>Saved</Text>
        </View>
        
        <View style={[tw`bg-gray-200 mt-15 w-1/4`]}>
          <Text style={[tw`text-gray-700 text-2xl font-bold mt-14 ml-7`]}>100</Text>
          <Text style={[tw`text-gray-500 text-xl font-normal ml-3 mb-3`]}>Stations</Text>
        </View>
 
         </View>
         <View style={[tw`bg-gray-200`]}>
         <TouchableOpacity onPress={() => props.navigation.navigate("Profile")} style={[tw`bg-gray-300 border-2 border-gray-200 ml-5 mr-5 mb-5`]}><Text style={[tw`text-gray-500 text-center text-xl font-bold p-1`]}>Edit Profile</Text></TouchableOpacity>  
         </View>

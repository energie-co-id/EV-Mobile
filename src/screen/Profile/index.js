...
function Profile(props) {
  ...
  return (
    <ScrollView>
        ...
        <View style={[tw`bg-gray-200 mt-5 mb- ml-0.21 w-1/4`]}>
        <View style={[tw`flex flex-row bg-gray-200`]}>
        <Text style={[tw`bg-gray-200 text-gray-700 text-xl font-semibold ml-5 mt-3`]}>Lucy</Text>
        <TouchableOpacity onPress={() => props.navigation.navigate("Profile")}><Image style={[tw`h-5 w-5 mt-4.7 ml-1.7justify-center items-center`]} source={require('../../assets/dropdown.png')}/></TouchableOpacity>
        ...
        <Text style={[tw`text-gray-700 text-xl font-semibold ml-8.7 mb-3`]}>Lucy</Text>
        </View>
    
         <View style={[tw`bg-gray-200 mt-15 w-1/4`]}>
          <Text style={[tw`text-gray-700 text-xl font-bold mt-14 ml-7`]}>105K</Text>
          <Text style={[tw`text-gray-500 text-lg font-normal ml-5 mb-3`]}>Charged</Text>
        </View>

        <View style={[tw`bg-gray-200 mt-15 w-1/4`]}>
          <Text style={[tw`text-gray-700  text-xl font-bold mt-14 ml-5`]}>40.1K</Text>
          <Text style={[tw`text-gray-500 text-lg font-normal ml-5 mb-5`]}>Saved</Text>
        </View>
        
        <View style={[tw`bg-gray-200 mt-15 w-1/4`]}>
          <Text style={[tw`text-gray-700  text-xl font-bold mt-14 ml-7`]}>100</Text>

...
const Charge = (props) => {
  ...
  <View style={[tw` rounded-xl bg-gray-100 w-100 h-100`]}>
    ...
    <TouchableOpacity onPress={() => props.navigation.navigate("Live")} style={[tw`rounded-xl border-gray-200 bg-gray-200 font-mono font-semibold ml-5 mr-5 mt-5 mb-21 py-2`]}><Text style={[tw`text-xl text-gray-700 font-bold font-mono ml-25`]}>Start Charging</Text></TouchableOpacity>
 </View>
</ScrollView>
  )
}

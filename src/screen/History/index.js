  ...
  return (
    <ScrollView>
      ...
      <Text style={[tw`text-gray-500 font-normal ml-11 mt-9`]}><Text style={[tw `text-3xl text-gray-500 font-bold`]}>History</Text>{`\n`}Present our charging record</Text>
        <TouchableOpacity onPress={() => props.navigation.navigate("Charger")}><Image source={require('../../assets/logo.png')}
      ...
      <View style={[tw`flex flex-row`]}>
      <TouchableOpacity onPress={() => props.navigation.navigate("Charge")}><Image source={require('../../assets/reverse.png')}
         style={[tw`w-9 h-9 ml-3 mt-5 mb-5`]}/></TouchableOpacity>
